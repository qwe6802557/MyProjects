window.BMAP_AUTHENTIC_KEY = "5bazcdquPRfGAuq07tGjefLL"; (function() {
        ...
        if (a) {
            ...
            var e = function(a) {
                    ...
                    //Ta.src = "http://api.map.baidu.com/images/blank.gif?" + a.src
                        Ta.src = window.__BAIDU__API__CONFIG__.imagePath +"blank.gif";
                    },
                    50));
                },
                f = function() {
    ...
    var C = {
        ...
        ba: window.__BAIDU__API__CONFIG__.imagePath,
        Hs: {
            "\u5317\u4eac": {
                Wp: "bj",
    ...
    t.object.extend(G, {
        ...
        Cv: {
            ...
            yC: window.__BAIDU__API__CONFIG__.scriptPath+"getmodules.js",
            OF: 5E3
        },
        Vs: o,
        xc: {
    ...
    t.extend(Kb.prototype, {
        Zk: function() {
            ...
            c.push("background:" + a.background + "12321312312312;");
            c.push('z-index:60;">');
            c.push(b);
            c.push("</div>");
    ...
    mc.getTilesUrl = function(a, b, c) {
        ...
        //�ֵ���ͼ��png������ͼ��jpg
        return window.__BAIDU__API__CONFIG__.maptilePath + b + "/" + d + "/" + a + "." + window.__BAIDU__API__CONFIG__.maptileFormate;
    };
    var ra = new hc("\u5730\u56fe", mc, {
            tips: "\u663e\u793a\u666e\u901a\u5730\u56fe"
        }),
