...
let XkjsShema = new Schema({
    ...
    xyrMoudle: {type:Object, require: true},//教学教研总模块，里面包括workLoad等所有子模块
})
let XkjsMoudel = mongoose.model('Xkjs',XkjsShema);
XkjsMoudel.ensureIndexes(function(err) {
    if (err) {
        console.log('err>> ',err);
    } else {
        console.log('success :>> ');
