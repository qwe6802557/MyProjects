        ...
        <el-table
          ...
          >
            <template slot-scope="scope" >
              <el-button type="text" size="mini" @click="showEditDialog(scope.row.ordersId)">查看</el-button>
              <el-button type="text" size="mini" @click="showEditDialog(scope.row.ordersId)">修改</el-button>
              <el-button type="text" size="mini" @click="removeById(scope.row.ordersId)">删除</el-button>
            </template>
          </el-table-column>
        </el-table>
        <!-- 分页区域 -->
