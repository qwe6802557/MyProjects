<template>
  <div id="skillsList">
    <el-tabs type="border-card">
      <el-tab-pane label="技巧文章">
        <el-form :inline="true" class="demo-form-inline">
          <el-form-item label="文章编号">
            <el-input clearable placeholder="请输入文章编号"></el-input>
          </el-form-item>
          <el-form-item label="文章名称">
            <el-input clearable placeholder="请输入文章名称"></el-input>
          </el-form-item>
          ...
          <el-form-item style="float: right">
            <el-button type="primary" plain @click="addFunc">添加文章</el-button>
          </el-form-item>
        </el-form>
        <el-table
          :data="skillsListData"
    ...
    <el-dialog
      ...
      <span>
        <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="100px" class="demo-ruleForm">
          <el-form-item label="文章编号" prop="detail_price">
              <el-input v-model="ruleForm.userTel" class="goods_price"></el-input>
          </el-form-item>
          <el-form-item label="文章名称" prop="detail_num">
...
export default {
  ...
  methods: {
    ...
    removeById () {
      MessageBox.confirm('确定要删除此文章吗?', '删除提示', {
