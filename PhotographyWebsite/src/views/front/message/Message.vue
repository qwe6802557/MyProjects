    ...
    <div class="subitem-content">
      <ul class="center-width">
        <li v-for="(item, index) in subitemArr" :key="index">
          ...
          <div class="li-center">
            <h3>{{item.title}}</h3>
            <el-tag :closable="false" :type="'warning'">精品文章</el-tag>
          </div>
          <div class="li-bottom">
            ...
            <div class="bottom-right">
              <a href="#" @click="showDetail">查看详情</a>
            </div>
          </div>
        </li>
      </ul>
...
export default {
  ...
  methods: {
    ...
    showDetail () {
      this.$router.push({ path: '/message/detail/1' }) // 动态路由 数字为可变化量
    }
  },
  mounted () {
