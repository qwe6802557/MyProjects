              ...
              <el-form :model="ruleForm" status-icon :rules="rules" ref="ruleForm" label-width="100px" class="demo-ruleForm">
                <el-row>
                  <el-col :span="24" :lg="8" :xl="6">
                    <el-form-item label="激活码" prop="pass" class="password">
                        <el-input v-model="ruleForm.pass" type="text" placeholder="请输入激活码" style="width: 60%;"></el-input>
                    </el-form-item>
                  </el-col>
                <!--  <el-col :span="8" :lg="6">
                      <el-form-item label="账号" prop="user" class="password">
                        <el-input v-model="ruleForm.user" type="text" placeholder="请输入账号" style="width: 60%;"></el-input>
                      </el-form-item>
                  </el-col>-->
                  <el-col :span="24" :lg="8" :xl="6">
                    <el-form-item label="价格" prop="price" class="password">
                      <el-input v-model="ruleForm.price" type="text" placeholder="请输入价格" style="width: 60%;"></el-input>
                    </el-form-item>
                  </el-col>
                  <el-col :span="24" :lg="8" :xl="6">
                    <el-form-item label="服务器" prop="server" class="password">
                      <el-select placeholder="请选择服务器" v-model="ruleForm.server" style="width: 60%;" filterable>
                        <el-option v-for="(item,index) in serverList" :value="item.value" :key="index" :label="item.lable"></el-option>
                      </el-select>
                      <el-button type="primary" round @click="reverseServer" style="margin-left: 15px;">倒序排列</el-button>
                    </el-form-item>
                  </el-col>
                </el-row>
              </el-form>
        ...
        <div class="add-button">
          <el-row>
            <el-col :span="24" style="text-align: center;">
              ...
              <el-button type="primary" round style="width: 120px;" @click="addInfo" :loading="loading" v-if="!this.$route.params.cList">添加</el-button>
...
<script>
  ...
  import { addPageInit, addInfo, editHero, orderDesc } from '@/api';
  import Vue from 'vue';
        ...
        editInfo(){
          ...
          this.$refs['ruleForm'].validate((boolean)=>{
            if (boolean==true){
              ...
              editHero(this.ruleForm).then(res => {
                const { status, data } = res;
                console.log(res);
                const { code } = data;
                if (status === 200 && code === 0 ){
