<template>
    <div class="background" v-bind:style="{height:windowsHeight}">
		<span class="tittle">图书管理</span>
		<div class="sousuo">
			<!-- <el-button type="primary" @click="add" class="sousuoIcon">添加图书</el-button> -->
...
import { releaseCategory,addBook,indexBook,updateBook,deleteBook,hotBook } from '../../api/index.js'
export default {
			data() {
				return {
					recommend:'',
